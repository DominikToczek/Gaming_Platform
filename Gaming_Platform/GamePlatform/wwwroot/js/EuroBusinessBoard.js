...
window.addEventListener('load', () => {
    ...
    let buyFieldModalButtonYes = document.querySelector(".buy-field-modal .buy-field-modal-button-yes")
    let buyFieldModalButtonNo = document.querySelector(".buy-field-modal .buy-field-modal-button-no")
    ...
    let buyHouseModalButtonYes = document.querySelector(".buy-house-modal .buy-house-modal-button-yes")
    let buyHouseModalButtonNo = document.querySelector(".buy-house-modal .buy-house-modal-button-no")
